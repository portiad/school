...
class ModelManager: NSObject {
    ...
    func persistentStoreDidImportUbiquitousContentChanges(notification: NSNotification) {
        ...
        moc.performBlock { () -> Void in
            ...
            allChanges.unionSet(changes.valueForKey(NSInsertedObjectsKey) as! Set<NSObject>)
            allChanges.unionSet(changes.valueForKey(NSUpdatedObjectsKey) as! Set<NSObject>)
            allChanges.unionSet(changes.valueForKey(NSDeletedObjectsKey) as! Set<NSObject>)
        }
